...
#y conforma un unico flujo de proceso, pero se optó por desarmarla en dos escenarios
#evitando el uso del And para mayor expresividad y buenas practicas.
#Ambos escenarios son independientes y matienen el aislamiento de prueba.
